...
r_max_f2 = 25
eps = 1e-10
TTCore_f1, TTRank_f1, InterpSet_I_f1 = TT_IDPRRLDU_L2R(qtensor_f1, r_max_f1, eps, 0)
TTCore_f2, TTRank_f2, InterpSet_I_f2 = TT_IDPRRLDU_L2R(qtensor_f2, r_max_f2, eps, 0)
InterpSet_I_f1[0] = []
InterpSet_I_f2[0] = []
...
print(f"Size of f1 full tensor {qtensor_f1.size}. Size of f1 QTT {size_tt(TTCore_f1)}, QTT compression ratio {qtensor_f1.size / size_tt(TTCore_f1)}")
print(f"Size of f2 full tensor {qtensor_f2.size}. Size of f2 QTT {size_tt(TTCore_f2)}, QTT compression ratio {qtensor_f2.size / size_tt(TTCore_f2)}")
...
print(f"Size of g full tensor {real_g.size}. Size of g QTT {size_tt(TT_cores_g)}, QTT compression ratio {real_g.size / size_tt(TT_cores_g)}")
