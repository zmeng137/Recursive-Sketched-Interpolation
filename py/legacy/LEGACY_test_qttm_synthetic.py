...
from tci import TT_CUR_L2R, TCI_2site, nested_initIJ_gen_rank1

''' === Quantics representation construction === '''
# Quantics construction
func1 = Function_Collection[5]
func2 = Function_Collection[6]
dim = 20
...
r_max_f2 = 10
eps = 1e-14
TTCore_f1, _, TTRank_f1, InterpSet_I_f1, _ = TT_CUR_L2R(f1_tensor, r_max_f1, eps, 0, 0)
TTCore_f2, _, TTRank_f2, InterpSet_I_f2, _ = TT_CUR_L2R(f2_tensor, r_max_f2, eps, 0, 0)
InterpSet_I_f1[0] = []
InterpSet_I_f2[0] = []
...
print(f"TT-Rank of QTCI-f1: {TTRank_f1}")
print(f"TT-Rank of QTCI-f2: {TTRank_f2}")
print(f"Size of f1 full tensor {f1_tensor.size}. Size of f1 QTT {size_tt(TTCore_f1)}")
print(f"Size of f2 full tensor {f2_tensor.size}. Size of f2 QTT {size_tt(TTCore_f2)}")
...
print(f"Relative error of f1 QTT at r_max = {r_max_f1}: {error_f1}, f2 QTT at r_max = {r_max_f2}: {error_f2}")

# Real g = f1 * f2 / Recon g = f1 * f2
real_g = f1_tensor * f2_tensor
