...
def quantics_function_tensor():
    ...
    qtensor_f, _ = load_quantics_tensor_formula(4, 20)
...
tt_f, tensor_f = quantics_function_tensor()
...
eps=1e-15
over_sampling = r_max
TT_cores_g, TTRank_g, interp_I_gBasis = NonlinearMapTT_RSI(tt_f, g_func, contract_number, r_max, eps, over_sampling, seed)
